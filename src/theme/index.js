...
const variableDefaults = {
  ...
  get metrics() {
    return {
      screenWidth: width,
      screenHeight: height,
      navBarHeight: isIphoneX() ? 88 : Header.HEIGHT,
...
export default variableOverrides =>
  merge(
    getTheme({ ...variableDefaults, ...variableOverrides }),
    getHomepassTheme({ ...variableDefaults, ...variableOverrides }),
  );
